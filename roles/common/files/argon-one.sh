...
# For the Argon ONE Pi4 V2 case, from https://argon40.com, this is
# a script (mostly, for me) to make the system fan less aggressive
# Mostly taken from the vendor's download with some modifications as described in
# https://forum.argon40.com/t/argon-one-script-on-raspy-os-trixie-installation-error/8933
